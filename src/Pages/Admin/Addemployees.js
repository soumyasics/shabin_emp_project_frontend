        ...
        <div className="d-flex  bg-secondary-subtle" id="wrapper">
            ...
            <div className='w-100' id="page-content-wrapper">
                ...
                <div className='container me-2'>
                    <form class="row g-3" >
                        <div>
                            <h4 class="text-center p-4 ">Add Employee Details</h4>
                            <hr></hr>
                        </div>
                        ...
                        <div className="col-md-4">
                            <label for="institute6" className="form-label">Institute</label>
                        ...
                        <div className="col-6">
                            <button className="btn btn-primary bg-success" onClick={handleAddEmployee}><i className="bi bi-upload"></i> Update</button>
                        </div>
                        <div className="col-6">
                            <button type="reset" className="btn btn-primary bg-warning" onClick={handleRest}><i className="bi bi-arrow-clockwise"></i> Reset</button>
                        </div>                       
                    </form>
                </div>

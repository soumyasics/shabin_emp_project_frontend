...
const AdminHighPriorityTickets = () => {
    ...
    return (
        <div className='d-flex bg-secondary-subtle' id='wrapper'>
            ...
            <div className='w-100' id='page-content-wrapper'>
                <NavbarAdmin />
                <h3 className='my-4 mx-2 p-2 rounded text-center bg-white text-danger shadow'>High Priority Tickets</h3>
                {detail.map((ticket, index) => (
                    <div key={index} className='  p-1 m-2 bg-white shadow rounded'>
                        <p className='fs-5 fw-bolder text-center bg-danger p-1 rounded'>Subject: {ticket.subject}</p>
...
export default AdminHighPriorityTickets